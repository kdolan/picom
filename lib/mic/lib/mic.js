...
var mic = function mic(options) {
    ...
    //DO NOT EXIT ON SILENCE - audioStream.setNumSilenceFramesExitThresh(parseInt(exitOnSilence, 10));
    //Instead use renamed method
    audioStream.setSilenceThresh(parseInt(exitOnSilence, 10));
